...
<div id="content">
  <div id="right">
    <form id="form1" name="form1" method="post" action="customer_sql_update.php">
                        <?  $sql="SELECT *
						FROM customer
						";
      ...
      <table width="400" border="1">
        ...
        <tr>
          ...
          <td><input type="file" name="product_picture" id="product_picture" value="<? echo $data["customer_picture"]?>" /> /></td>
        </tr>
      </table>
      <p><center>
