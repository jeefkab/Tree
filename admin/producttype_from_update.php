...
<center>
 ...
 ยินดีต้อนรับ Name [<? echo $data["customer_name"]?>] 
    ...
    <form id="form1" name="form1" method="post" action="producttype_sql_update.php">
                                  <?  $sql="SELECT *
						FROM producttype
      ...
      <div align="center">
          ...
          <tr>
            ...
            <td width="260" bgcolor="#FFFFFF"><? echo $data["producttype_id"]?></td>
			<!-- โจมืงต้องฝาก input type="hidden" ไปด้วยเพราะมันต้องส่งค่าให้ sql ไปอัพลงฐาน producttype_id -->
			<input type="hidden" name="producttype_id" value="<? echo $data["producttype_id"]?>"/>
          </tr>
          <tr>
            <td height="24" align="center" bgcolor="#99FF33">ชื่อประเภทของสินค้า</td>
            <td bgcolor="#FFFFFF"><input type="text" name="producttype_name" id="producttype_name" value="<? echo $data["producttype_name"]?>" /></td>
          </tr>
          <tr>
