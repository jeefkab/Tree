...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <div align="center">
      <form action="product_sql_add.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
        <p>&nbsp;</p>
        <table width="400" border="1" align="center">
          <tr bgcolor="#99FF33">
            <td colspan="2" align="center" bgcolor="#99FF33">สินค้า และประเภทของสินค้าได้</td>
          </tr>
          <tr>
            <td width="140" height="24" align="center" bgcolor="#99FF33">รหัสสินค้า</td>
            <td width="260" bgcolor="#FFFFFF"><input type="text" name="product_id" id="product_id" /></td>
          </tr>
          <tr>
            <td height="24" align="center" bgcolor="#99FF33">ชื่อสินค้า</td>
            <td bgcolor="#FFFFFF"><input type="text" name="product_name" id="product_name" /></td>
          </tr>
          <tr>
            <td height="24" align="center" bgcolor="#99FF33">ประเภท</td>
            <td bgcolor="#FFFFFF"><input type="text" name="product_type" id="product_type" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input type="text" name="product_price" id="product_price" /></td>
          </tr>
          <tr>
            <td height="24" align="center" bgcolor="#99FF33">จำนวนคงเหลือ</td>
            <td bgcolor="#FFFFFF"><input type="text" name="product_stock" id="product_stock" /></td>
          </tr>
          <tr>
