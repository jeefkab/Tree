  ...
  <select name="select4" id="select7">
      ...
      <div align="center">
    	      ...
    	      <tr bgcolor="#FFFF33">
    	        ...
    	        <td width="88" align="center">เลขที่ใบสั่งซื้อ</td>
    	        <td width="114" align="center">ชื่อลูกค้า</td>
                <td width="97" align="center">วันที่สั่งสินค้า</td>
                <td width="148" align="center">สถานะการชำระเงิน</td>
    	        </tr>
    	      <?
    $sql = "
		SELECT *
